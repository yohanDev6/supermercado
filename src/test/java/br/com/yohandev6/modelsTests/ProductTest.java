...
public class ProductTest {
	...
	void shouldBuildProductCorrectly() {
		Product p = Product.builder()
				.id(1L)
				.name("Arroz 5kg")
				.validity(LocalDate.of(2025, 12, 31))
				.price(new BigDecimal("25.90"))
				.build();

		assertThat(p.getId()).isEqualTo(1L);
        assertThat(p.getName()).isEqualTo("Arroz 5kg");
        assertThat(p.getValidity()).isEqualTo(LocalDate.of(2025, 12, 31));
    ...
    void shouldCompareProductsCorrectly() {
        Product p1 = Product.builder()
                .id(1L)
                .name("Feijão")
                .validity(LocalDate.of(2026, 1, 10))
    ...
    void shouldGenerateReadableToString() {
        Product p = Product.builder()
                .id(2L)
                .name("Café 500g")
                .validity(LocalDate.of(2025, 9, 30))
